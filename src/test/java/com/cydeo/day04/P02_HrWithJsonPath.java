...
/*
       #  we are filtering the results by using Gpath after we got the Json results response
          even converting to Json path and getting the response

       #  "items.findAll     {it.    region_id==2}         .country_name"
       #  find all of them -> if ->  the region id is 2 -->get me the country name  field*/
